...
import apps.lnsel.com.messengerplus.views.SignupScreen.SignupActivityView;
...
public class SignupPresenter {
    ...
    public void signupService(String url, final String usrUserName, final String usrPassword){
